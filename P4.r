  ...
  symbols <- read.csv("C:\\Users\\MikkelNørgaard\\Downloads\\tickers (2).csv")[,"symbol"]
  #symbols <- read.csv("Downloads\\tickers_reduced_list.csv")[,"Symbol"]
  ...
  write.csv(all_returns, "C:\\Users\\MikkelNørgaard\\OneDrive - Youlend\\Desktop\\AAU\\4. Semester\\P4\\sp500_yearly_all_data_2021_2023.csv", row.names = index(all_returns))